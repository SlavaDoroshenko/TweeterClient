...
public class TweetAdapter extends RecyclerView.Adapter<TweetAdapter.TweetViewHolder> {
    ...
    class TweetViewHolder extends RecyclerView.ViewHolder {
        ...
        public TweetViewHolder(View itemView) {
            ...
            creationDateTextView = itemView.findViewById(R.id.creation_data_text_view);
            ...
            likesTextView = itemView.findViewById(R.id.like_text_view);
        }

        public void bind(Tweet tweet) {
            nameTextView.setText(tweet.getUser().getName());
            nickTextView.setText(tweet.getUser().getNick());
            contentTextView.setText(tweet.getTextContentTweet());
            retweetsTextView.setText(String.valueOf(tweet.getRetweet()));
            likesTextView.setText(String.valueOf(tweet.getLike()));
            String creationDateFormatted = getFormattedDate(tweet.getData());
